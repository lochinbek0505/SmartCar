...
import 'package:smart_car/controllers/intro_controller.dart';
import 'package:smart_car/screens/lock_screen.dart';
import 'package:smart_car/services/constants/images.dart';
import 'package:smart_car/services/constants/svg_icon.dart';
import 'package:smart_car/services/themes/colors.dart';
import 'package:smart_car/services/themes/text_styles.dart';
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  text,
                  style: AppTextStyles.sfProDisplay17.copyWith(
                    color: Colors.white,
                  ),
                ),
                CustomButtonAppBar(widget: SvgIcon.lock, onPressed: onPress),
              ],
            ),
          ),
        ),
