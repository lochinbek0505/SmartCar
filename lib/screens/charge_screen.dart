...
import '../services/themes/text_styles.dart';
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    CustomButtonAppBar(
                      widget: SvgIcon.chevron_left.copyWith(
                        newHeight: 18,
                        newWidth: 10,
                      ),
                      onPressed: () {
                        ...
                        child: SizedBox(
                          ...
                          child: Neumorphic(
                            style: NeumorphicStyle(
                              ...
                              shadowLightColorEmboss: Colors.white.withOpacity(
                                0.5,
                              ),
                ...
                AnimatedContainer(
                  ...
                  child: Neumorphic(
                    style: NeumorphicStyle(
                      ...
                      shadowLightColorEmboss: const Color.fromRGBO(
                        255,
                        255,
                        255,
                        0.25,
...
class BatteryIndicator extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint paint1 =
        Paint()..maskFilter = const MaskFilter.blur(BlurStyle.inner, 0);
