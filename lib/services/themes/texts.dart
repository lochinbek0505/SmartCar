...
class Texts {
  ...
  static Text strTesla = Text(
    "str_tesla",
    style: AppTextStyles.sfProDisplay28.copyWith(
  ...
  static Text strClimate = Text(
    "str_climate",
    style: AppTextStyles.sfProDisplay20.copyWith(
      color: AppColors.lightShadowlight,
    ),
  );
  ...
  static Text strC20 = Text(
    "str_c20",
    style: AppTextStyles.sfProDisplay34.copyWith(
      color: AppColors.lightShadowlight,
    ),
  );
